...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p Cada mercado debe conocer sus clientes, la manera cómo decide comprar, cómo convertirlo de Shopper a Buyer y monetizarlo, etc. Este cliente sigue un proceso racional de compra, de acuerdo como lo indica Promove Consultoría e Formación, SLNE (2012, p. 15). 
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-8
        ...
        p Este mercado, del cual las personas compran bienes y servicios para su uso personal o familiar, tiene comportamientos y decisiones de compra en los consumidores: ¿dónde?, ¿cómo?, ¿cuándo compran?, ¿qué cantidad?, ¿por qué lo hacen? Estos son los interrogantes que a las empresas les interesa conocer para presentar una oferta que le genere valor al cliente.
    ...
    .row.justify-content-center.align-items-center
      ...
      .col-lg-3.col-md-6.col-8
       img.py-2(data-aos="zoom-in-left")(src='@/assets/curso/temas/Tema1/img10.png' alt='AvatarTop')
        ...
        ol.lista-ol--cuadro.lista-ol--separador
          li.d-flex
            .lista-ol--cuadro__vineta
              span 1
            p.mb-0 Mercados de productos agropecuarios y procedentes del mar.

          li.d-flex 
            .lista-ol--cuadro__vineta
              span 2
            p.mb-0 Mercados de materias primas.

          li.d-flex 
            .lista-ol--cuadro__vineta
              span 3
            p.mb-0 Mercados de productos técnicos o industriales.

          li.d-flex 
            .lista-ol--cuadro__vineta
              span 4
            p.mb-0 Mercados de productos manufacturados.

          li.d-flex 
            .lista-ol--cuadro__vineta
              span 5
            p.mb-0 Mercados de servicios.
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-right")
      ...
      .col-lg-8
        .cajon.color-acento-contenido.p-4.mb-4
          h5 El Gobierno o las dependencias de Gobierno actúan como clientes en este mercado, puesto que compran los bienes y servicios de otras empresas para ulteriormente  ofrecer servicios públicos. 
          p (Quiroa, 2020).
